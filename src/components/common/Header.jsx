				...
				<div className='d-lg-flex d-none justify-content-between align-items-center'>
					...
					{userId && (
						<div class='dms-block w-md h-40px ms-4 center px-2'>
							<div className='dms-btn w-100 me-2  center'>0</div>
							<div className='dms-btn w-100  center'>DMS</div>
						</div>
					)}
					{!userId && (
						<div
							class={`${userId ? 'w-25' : 'px-5'} header-Connect-btn h-40px ms-4 center bold cursor`}
					...
					{userId && (
						<div class='dropdown ms-4'>
							<button
								class='btn  w-45px h-45px rounded-circle text-white border border-warning center'
								type='button'
